...
public class ScaleLAcross {
	...
	public static void run() {
		...
		else if(Auton.getStage() == 1 && Robot.driveAutonSimple(85, 35)) {
			Auton.resetThings();
		}
		...
		else if(Auton.getStage() == 4 && Robot.raiseArm(Robot.SCALEHEIGHT, false) && Robot.driveAutonSimple(22, 78)) {
			Auton.resetThings();
		}
		...
		else if(Auton.getStage() == 7 && Robot.shortDriveSlow(6)) {
			Auton.resetThings();
		}
...
//		else if(Auton.getStage() == 12 && Robot.limelightPickUp()) {
//			Auton.resetThings();
//		}
	}
